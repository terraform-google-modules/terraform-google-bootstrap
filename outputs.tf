...
output "terraform_sa_email" {
  ...
  value       = var.create_terraform_service_account ? google_service_account.org_terraform[0].email : ""
  depends_on = [
...
output "terraform_sa_name" {
  ...
  value       = var.create_terraform_service_account ? google_service_account.org_terraform[0].name : ""
}
